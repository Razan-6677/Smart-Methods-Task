# Task 3 - Ultrasonic Sensor & Servo Motor Control
...
2. **Servo Activation:** If an object is detected at a distance of 10 cm or less, the Arduino commands the servo motor to rotate to a targeted angle.
3. **LED Indicator (Optional):** When the servo moves to the target angle, the LED turns ON to visually indicate the detection.
...
![Simulation Circuit](images/simulation.png)
...
- **Source Code:** [code/sketch.ino](code/sketch.ino)

---
#Arduino #Wokwi #Robotics #ServoMotor #Ultrasonic #SmartMethods #HCSR04
