...
The body is a simple box-shaped frame representing the robot's torso. The material used is PLA+ plastic, because it is lightweight (reducing load on the servos) and easy to manufacture (suitable for an early prototype stage).

![Figure 1: General frame of the robot](images/figure1-frame.jpg)

## 2) Leg Design
Each of the robot's four legs is made up of 3 links, with the following lengths:
...
![Figure 2: Joint details of a single leg (L1, L2, L3)](images/figure2-leg-joints.jpg)
...
![Center of gravity and stability diagram](images/figure3-stability.jpg)
...
This gait was chosen because it is the most suitable compared to other walking patterns: it is stable, keeps the center of gravity balanced, and is inspired by how real animals such as dogs, cats, and sheep walk.
